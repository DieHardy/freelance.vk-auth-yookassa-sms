...
| public | [$login](YooKassa-Model-PaymentMethod-PaymentMethodAlfaBank.md#property_login) |  | Имя пользователя в Альфа-Клике |
...
| public | [$type](YooKassa-Model-PaymentMethod-PaymentMethodAlfaBank.md#property_type) |  | Тип объекта |

---
### Methods
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-PaymentMethod-PaymentMethodAlfaBank.md#method___construct) |  |  |
...
| public | [getLogin()](YooKassa-Model-PaymentMethod-PaymentMethodAlfaBank.md#method_getLogin) |  | Возвращает имя пользователя в Альфа-Клике |
...
| public | [setLogin()](YooKassa-Model-PaymentMethod-PaymentMethodAlfaBank.md#method_setLogin) |  | Устанавливает имя пользователя в Альфа-Клике |
...
**Details:**
* Inherited From: [\YooKassa\Model\PaymentMethod\PaymentMethodAlfaBank](YooKassa-Model-PaymentMethod-PaymentMethodAlfaBank.md)
