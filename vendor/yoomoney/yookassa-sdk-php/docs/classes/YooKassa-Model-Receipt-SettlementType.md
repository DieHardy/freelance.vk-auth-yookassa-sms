...
| ----------:| ---- | ---- | ------- |
| public | [CASHLESS](YooKassa-Model-Receipt-SettlementType.md#constant_CASHLESS) |  | Безналичный расчет |
| public | [PREPAYMENT](YooKassa-Model-Receipt-SettlementType.md#constant_PREPAYMENT) |  | Предоплата (аванс) |
| public | [POSTPAYMENT](YooKassa-Model-Receipt-SettlementType.md#constant_POSTPAYMENT) |  | Постоплата (кредит) |
| public | [CONSIDERATION](YooKassa-Model-Receipt-SettlementType.md#constant_CONSIDERATION) |  | Встречное предоставление |

---
### Properties
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| protected | [$validValues](YooKassa-Model-Receipt-SettlementType.md#property_validValues) |  |  |
