...
| ----------:| ---- | ---- | ------- |
| public | [getAccount()](YooKassa-Model-PaymentMethod-B2b-Sberbank-PayerBankDetailsInterface.md#method_getAccount) |  | Возвращает номер счета организации |
| public | [getAddress()](YooKassa-Model-PaymentMethod-B2b-Sberbank-PayerBankDetailsInterface.md#method_getAddress) |  | Возвращает адрес организации |
| public | [getBankBik()](YooKassa-Model-PaymentMethod-B2b-Sberbank-PayerBankDetailsInterface.md#method_getBankBik) |  | Возвращает БИК банка организации |
| public | [getBankBranch()](YooKassa-Model-PaymentMethod-B2b-Sberbank-PayerBankDetailsInterface.md#method_getBankBranch) |  | Возвращает отделение банка организации |
| public | [getBankName()](YooKassa-Model-PaymentMethod-B2b-Sberbank-PayerBankDetailsInterface.md#method_getBankName) |  | Возвращает наименование банка организации |
| public | [getFullName()](YooKassa-Model-PaymentMethod-B2b-Sberbank-PayerBankDetailsInterface.md#method_getFullName) |  | Возвращает полное наименование организации |
| public | [getInn()](YooKassa-Model-PaymentMethod-B2b-Sberbank-PayerBankDetailsInterface.md#method_getInn) |  | Возвращает ИНН организации |
| public | [getKpp()](YooKassa-Model-PaymentMethod-B2b-Sberbank-PayerBankDetailsInterface.md#method_getKpp) |  | Возвращает КПП организации |
| public | [getShortName()](YooKassa-Model-PaymentMethod-B2b-Sberbank-PayerBankDetailsInterface.md#method_getShortName) |  | Возвращает сокращенное наименование организации |
...
**Details:**
* Inherited From: [\YooKassa\Model\PaymentMethod\B2b\Sberbank\PayerBankDetailsInterface](YooKassa-Model-PaymentMethod-B2b-Sberbank-PayerBankDetailsInterface.md)
