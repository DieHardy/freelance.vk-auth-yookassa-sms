...
| ----------:| ---- | ---- | ------- |
| public | [$currency](YooKassa-Model-Receipt-ReceiptItemAmount.md#property_currency) |  | Код валюты |
| public | [$value](YooKassa-Model-Receipt-ReceiptItemAmount.md#property_value) |  | Сумма |

---
### Methods
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-Receipt-ReceiptItemAmount.md#method___construct) |  | MonetaryAmount constructor. |
...
| public | [getCurrency()](YooKassa-Model-Receipt-ReceiptItemAmount.md#method_getCurrency) |  | Возвращает валюту |
| public | [getIntegerValue()](YooKassa-Model-Receipt-ReceiptItemAmount.md#method_getIntegerValue) |  | Возвращает сумму в копейках в виде целого числа |
| public | [getValue()](YooKassa-Model-Receipt-ReceiptItemAmount.md#method_getValue) |  | Возвращает значение суммы |
| public | [increase()](YooKassa-Model-Receipt-ReceiptItemAmount.md#method_increase) |  | Увеличивает сумму на указанное значение |
| public | [jsonSerialize()](YooKassa-Model-Receipt-ReceiptItemAmount.md#method_jsonSerialize) |  | Возвращает ассоциативный массив со свойствами текущего объекта для его дальнейшей JSON сериализации |
| public | [multiply()](YooKassa-Model-Receipt-ReceiptItemAmount.md#method_multiply) |  | Умножает текущую сумму на указанный коэффициент |
...
| public | [setCurrency()](YooKassa-Model-Receipt-ReceiptItemAmount.md#method_setCurrency) |  | Устанавливает код валюты |
| public | [setValue()](YooKassa-Model-Receipt-ReceiptItemAmount.md#method_setValue) |  | Устанавливает значение суммы |
...
* Implements:
  * [\YooKassa\Model\AmountInterface](YooKassa-Model-AmountInterface.md)
...
**Details:**
* Inherited From: [\YooKassa\Model\Receipt\ReceiptItemAmount](YooKassa-Model-Receipt-ReceiptItemAmount.md)
