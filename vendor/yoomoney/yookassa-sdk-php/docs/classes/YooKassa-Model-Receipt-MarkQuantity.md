...
| ----------:| ---- | ---- | ------- |
| public | [MIN_VALUE](YooKassa-Model-Receipt-MarkQuantity.md#constant_MIN_VALUE) |  |  |

---
### Properties
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [$denominator](YooKassa-Model-Receipt-MarkQuantity.md#property_denominator) |  | Знаменатель — общее количество товаров в потребительской упаковке (тег в 54 ФЗ — 1294) |
| public | [$numerator](YooKassa-Model-Receipt-MarkQuantity.md#property_numerator) |  | Числитель — количество продаваемых товаров из одной потребительской упаковки (тег в 54 ФЗ — 1293) |
...
| public | [getDenominator()](YooKassa-Model-Receipt-MarkQuantity.md#method_getDenominator) |  | Возвращает знаменатель |
| public | [getNumerator()](YooKassa-Model-Receipt-MarkQuantity.md#method_getNumerator) |  | Возвращает числитель |
...
| public | [setDenominator()](YooKassa-Model-Receipt-MarkQuantity.md#method_setDenominator) |  | Устанавливает знаменатель |
| public | [setNumerator()](YooKassa-Model-Receipt-MarkQuantity.md#method_setNumerator) |  | Устанавливает числитель |
...
**Details:**
* Inherited From: [\YooKassa\Model\Receipt\MarkQuantity](YooKassa-Model-Receipt-MarkQuantity.md)
