...
| ----------:| ---- | ---- | ------- |
| public | [$id](YooKassa-Model-Deal-PayoutDealInfo.md#property_id) |  | Идентификатор сделки |
...
| public | [getId()](YooKassa-Model-Deal-PayoutDealInfo.md#method_getId) |  | Возвращает Id сделки |
...
| public | [setId()](YooKassa-Model-Deal-PayoutDealInfo.md#method_setId) |  | Устанавливает Id сделки |
...
**Details:**
* Inherited From: [\YooKassa\Model\Deal\PayoutDealInfo](YooKassa-Model-Deal-PayoutDealInfo.md)
