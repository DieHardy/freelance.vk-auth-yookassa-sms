...
| ----------:| ---- | ---- | ------- |
| public | [$amount](YooKassa-Request-Payouts-IncomeReceiptData.md#property_amount) |  | Сумма для печати в чеке |
| public | [$service_name](YooKassa-Request-Payouts-IncomeReceiptData.md#property_service_name) |  | Описание услуги, оказанной получателем выплаты. Не более 50 символов |
| public | [$serviceName](YooKassa-Request-Payouts-IncomeReceiptData.md#property_serviceName) |  | Описание услуги, оказанной получателем выплаты. Не более 50 символов |
...
| public | [getAmount()](YooKassa-Request-Payouts-IncomeReceiptData.md#method_getAmount) |  | Возвращает сумму для печати в чеке. |
| public | [getServiceName()](YooKassa-Request-Payouts-IncomeReceiptData.md#method_getServiceName) |  | Возвращает описание услуги, оказанной получателем выплаты. |
...
| public | [setAmount()](YooKassa-Request-Payouts-IncomeReceiptData.md#method_setAmount) |  | Устанавливает сумму для печати в чеке. |
| public | [setServiceName()](YooKassa-Request-Payouts-IncomeReceiptData.md#method_setServiceName) |  | Устанавливает описание услуги, оказанной получателем выплаты. |
...
**Details:**
* Inherited From: [\YooKassa\Request\Payouts\IncomeReceiptData](YooKassa-Request-Payouts-IncomeReceiptData.md)
