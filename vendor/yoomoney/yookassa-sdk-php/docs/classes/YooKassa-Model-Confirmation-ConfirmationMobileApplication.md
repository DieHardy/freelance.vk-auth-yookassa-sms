...
| ----------:| ---- | ---- | ------- |
| public | [$confirmation_url](YooKassa-Model-Confirmation-ConfirmationMobileApplication.md#property_confirmation_url) |  | URL на который необходимо перенаправить плательщика для подтверждения оплаты |
| public | [$confirmationUrl](YooKassa-Model-Confirmation-ConfirmationMobileApplication.md#property_confirmationUrl) |  | URL на который необходимо перенаправить плательщика для подтверждения оплаты |
| public | [$return_url](YooKassa-Model-Confirmation-ConfirmationMobileApplication.md#property_return_url) |  | URL на который вернется плательщик после подтверждения или отмены платежа на странице партнера |
| public | [$returnUrl](YooKassa-Model-Confirmation-ConfirmationMobileApplication.md#property_returnUrl) |  | URL на который вернется плательщик после подтверждения или отмены платежа на странице партнера |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-Confirmation-ConfirmationMobileApplication.md#method___construct) |  |  |
...
| public | [getConfirmationUrl()](YooKassa-Model-Confirmation-ConfirmationMobileApplication.md#method_getConfirmationUrl) |  |  |
| public | [getReturnUrl()](YooKassa-Model-Confirmation-ConfirmationMobileApplication.md#method_getReturnUrl) |  |  |
...
| public | [setConfirmationUrl()](YooKassa-Model-Confirmation-ConfirmationMobileApplication.md#method_setConfirmationUrl) |  |  |
| public | [setReturnUrl()](YooKassa-Model-Confirmation-ConfirmationMobileApplication.md#method_setReturnUrl) |  |  |
...
**Details:**
* Inherited From: [\YooKassa\Model\Confirmation\ConfirmationMobileApplication](YooKassa-Model-Confirmation-ConfirmationMobileApplication.md)
