...
| ----------:| ---- | ---- | ------- |
| public | [$account_number](YooKassa-Model-Payout-PayoutDestinationYooMoney.md#property_account_number) |  | Номер кошелька в ЮMoney, с которого была произведена оплата |
| public | [$accountNumber](YooKassa-Model-Payout-PayoutDestinationYooMoney.md#property_accountNumber) |  | Номер кошелька в ЮMoney, с которого была произведена оплата |
| public | [$type](YooKassa-Model-Payout-PayoutDestinationYooMoney.md#property_type) |  | Тип объекта |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-Payout-PayoutDestinationYooMoney.md#method___construct) |  |  |
...
| public | [getAccountNumber()](YooKassa-Model-Payout-PayoutDestinationYooMoney.md#method_getAccountNumber) |  | Возвращает номер кошелька в ЮMoney, с которого была произведена оплата |
...
| public | [setAccountNumber()](YooKassa-Model-Payout-PayoutDestinationYooMoney.md#method_setAccountNumber) |  | Устанавливает номер кошелька в ЮMoney, с которого была произведена оплата |
...
**Details:**
* Inherited From: [\YooKassa\Model\Payout\PayoutDestinationYooMoney](YooKassa-Model-Payout-PayoutDestinationYooMoney.md)
