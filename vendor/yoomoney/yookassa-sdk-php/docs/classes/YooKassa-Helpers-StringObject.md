...
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Helpers-StringObject.md#method___construct) |  | StringObject constructor. |
| public | [__toString()](YooKassa-Helpers-StringObject.md#method___toString) |  | Возвращает строковое значение текущего объекта |
...
**Details:**
* Inherited From: [\YooKassa\Helpers\StringObject](YooKassa-Helpers-StringObject.md)
