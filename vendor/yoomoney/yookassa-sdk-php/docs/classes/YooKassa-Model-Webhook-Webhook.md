...
| ----------:| ---- | ---- | ------- |
| public | [$event](YooKassa-Model-Webhook-Webhook.md#property_event) |  | Событие, о котором уведомляет ЮKassa |
| public | [$id](YooKassa-Model-Webhook-Webhook.md#property_id) |  | Идентификатор webhook |
| public | [$url](YooKassa-Model-Webhook-Webhook.md#property_url) |  | URL, на который ЮKassa будет отправлять уведомления |
...
| public | [getEvent()](YooKassa-Model-Webhook-Webhook.md#method_getEvent) |  | Возвращает событие, о котором уведомляет ЮKassa |
| public | [getId()](YooKassa-Model-Webhook-Webhook.md#method_getId) |  | Возвращает идентификатор webhook |
| public | [getUrl()](YooKassa-Model-Webhook-Webhook.md#method_getUrl) |  | Возвращает URL, на который ЮKassa будет отправлять уведомления |
...
| public | [setEvent()](YooKassa-Model-Webhook-Webhook.md#method_setEvent) |  | Устанавливает событие, о котором уведомляет ЮKassa |
| public | [setId()](YooKassa-Model-Webhook-Webhook.md#method_setId) |  | Устанавливает идентификатор webhook |
| public | [setUrl()](YooKassa-Model-Webhook-Webhook.md#method_setUrl) |  | Устанавливает URL, на который ЮKassa будет отправлять уведомления |
...
**Details:**
* Inherited From: [\YooKassa\Model\Webhook\Webhook](YooKassa-Model-Webhook-Webhook.md)
