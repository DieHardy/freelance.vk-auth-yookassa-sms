...
| ----------:| ---- | ---- | ------- |
| public | [$booking_reference](YooKassa-Model-Airline.md#property_booking_reference) |  | Номер бронирования. Обязателен на этапе создания платежа |
| public | [$bookingReference](YooKassa-Model-Airline.md#property_bookingReference) |  | Номер бронирования. Обязателен на этапе создания платежа |
| public | [$legs](YooKassa-Model-Airline.md#property_legs) |  | Список маршрутов |
| public | [$passengers](YooKassa-Model-Airline.md#property_passengers) |  | Список пассажиров |
| public | [$ticket_number](YooKassa-Model-Airline.md#property_ticket_number) |  | Уникальный номер билета. Обязателен на этапе подтверждения платежа |
| public | [$ticketNumber](YooKassa-Model-Airline.md#property_ticketNumber) |  | Уникальный номер билета. Обязателен на этапе подтверждения платежа |
...
| public | [addLeg()](YooKassa-Model-Airline.md#method_addLeg) |  | Добавляет объект-контейнер с данными о маршруте |
| public | [addPassenger()](YooKassa-Model-Airline.md#method_addPassenger) |  | Добавляет объект-контейнер с данными пассажиров |
| public | [fromArray()](YooKassa-Model-Airline.md#method_fromArray) |  | Устанавливает значения свойств текущего объекта из массива |
| public | [getBookingReference()](YooKassa-Model-Airline.md#method_getBookingReference) |  | Номер бронирования. Обязателен на этапе создания платежа. |
| public | [getLegs()](YooKassa-Model-Airline.md#method_getLegs) |  | Список объектов-контейнеров с данными о маршруте |
| public | [getPassengers()](YooKassa-Model-Airline.md#method_getPassengers) |  | Список объектов-контейнеров с данными пассажиров |
| public | [getTicketNumber()](YooKassa-Model-Airline.md#method_getTicketNumber) |  | Уникальный номер билета. Обязателен на этапе подтверждения платежа |
...
| public | [notEmpty()](YooKassa-Model-Airline.md#method_notEmpty) |  | Првоерка на наличие данных |
...
| public | [setBookingReference()](YooKassa-Model-Airline.md#method_setBookingReference) |  | Устанавливает номер бронирования. Обязателен на этапе создания платежа. |
| public | [setLegs()](YooKassa-Model-Airline.md#method_setLegs) |  | Устанавливает список объектов-контейнеров с данными о маршруте |
| public | [setPassengers()](YooKassa-Model-Airline.md#method_setPassengers) |  | Устанавливает список объектов-контейнеров с данными пассажиров |
| public | [setTicketNumber()](YooKassa-Model-Airline.md#method_setTicketNumber) |  | Устанавливает уникальный номер билета. Обязателен на этапе подтверждения платежа |
...
* Implements:
  * [\YooKassa\Model\AirlineInterface](YooKassa-Model-AirlineInterface.md)
...
**Details:**
* Inherited From: [\YooKassa\Model\Airline](YooKassa-Model-Airline.md)
