...
| public | [getId()](YooKassa-Request-Payouts-PayoutPersonalData.md#method_getId) |  | Возвращает идентификатор персональных данных. |
...
| public | [setId()](YooKassa-Request-Payouts-PayoutPersonalData.md#method_setId) |  | Устанавливает идентификатор персональных данных. |
...
**Details:**
* Inherited From: [\YooKassa\Request\Payouts\PayoutPersonalData](YooKassa-Request-Payouts-PayoutPersonalData.md)
