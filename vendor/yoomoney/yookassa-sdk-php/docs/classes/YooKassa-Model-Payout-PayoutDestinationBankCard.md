...
| ----------:| ---- | ---- | ------- |
| public | [$card](YooKassa-Model-Payout-PayoutDestinationBankCard.md#property_card) |  | Данные банковской карты |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-Payout-PayoutDestinationBankCard.md#method___construct) |  |  |
...
| public | [getCard()](YooKassa-Model-Payout-PayoutDestinationBankCard.md#method_getCard) |  | Возвращает данные банковской карты |
...
| public | [setCard()](YooKassa-Model-Payout-PayoutDestinationBankCard.md#method_setCard) |  | Устанавливает данные банковской карты |
...
**Details:**
* Inherited From: [\YooKassa\Model\Payout\PayoutDestinationBankCard](YooKassa-Model-Payout-PayoutDestinationBankCard.md)
