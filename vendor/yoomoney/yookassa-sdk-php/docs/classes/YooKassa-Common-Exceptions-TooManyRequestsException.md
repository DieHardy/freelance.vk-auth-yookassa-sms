...
| ----------:| ---- | ---- | ------- |
| public | [HTTP_CODE](YooKassa-Common-Exceptions-TooManyRequestsException.md#constant_HTTP_CODE) |  |  |

---
### Properties
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [$retryAfter](YooKassa-Common-Exceptions-TooManyRequestsException.md#property_retryAfter) |  |  |
| public | [$type](YooKassa-Common-Exceptions-TooManyRequestsException.md#property_type) |  |  |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Common-Exceptions-TooManyRequestsException.md#method___construct) |  | Constructor |
...
**Details:**
* Inherited From: [\YooKassa\Common\Exceptions\TooManyRequestsException](YooKassa-Common-Exceptions-TooManyRequestsException.md)
