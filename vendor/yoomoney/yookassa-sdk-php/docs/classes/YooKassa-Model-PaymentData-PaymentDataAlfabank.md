...
| ----------:| ---- | ---- | ------- |
| public | [$login](YooKassa-Model-PaymentData-PaymentDataAlfabank.md#property_login) |  | Имя пользователя в Альфа-Клике |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-PaymentData-PaymentDataAlfabank.md#method___construct) |  |  |
...
| public | [getLogin()](YooKassa-Model-PaymentData-PaymentDataAlfabank.md#method_getLogin) |  | Возвращает имя пользователя в Альфа-Клике |
...
| public | [setLogin()](YooKassa-Model-PaymentData-PaymentDataAlfabank.md#method_setLogin) |  | Устанавливает имя пользователя в Альфа-Клике |
...
**Details:**
* Inherited From: [\YooKassa\Model\PaymentData\PaymentDataAlfabank](YooKassa-Model-PaymentData-PaymentDataAlfabank.md)
