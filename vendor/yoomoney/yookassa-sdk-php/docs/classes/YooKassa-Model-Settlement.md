...
| ----------:| ---- | ---- | ------- |
| public | [$amount](YooKassa-Model-Settlement.md#property_amount) |  | Размер оплаты |
| public | [$type](YooKassa-Model-Settlement.md#property_type) |  | Вид оплаты в чеке |
...
| public | [getAmount()](YooKassa-Model-Settlement.md#method_getAmount) |  | Возвращает размер оплаты |
| public | [getType()](YooKassa-Model-Settlement.md#method_getType) |  | Возвращает вид оплаты в чеке (cashless | prepayment | postpayment | consideration) |
...
| public | [setAmount()](YooKassa-Model-Settlement.md#method_setAmount) |  | Устанавливает сумму платежа |
| public | [setType()](YooKassa-Model-Settlement.md#method_setType) |  | Устанавливает вид оплаты в чеке |
...
**Details:**
* Inherited From: [\YooKassa\Model\Settlement](YooKassa-Model-Settlement.md)
