...
| ----------:| ---- | ---- | ------- |
| public | [$inn](YooKassa-Model-Supplier.md#property_inn) |  | ИНН пользователя (10 или 12 цифр) |
| public | [$name](YooKassa-Model-Supplier.md#property_name) |  | Наименование поставщика |
| public | [$phone](YooKassa-Model-Supplier.md#property_phone) |  | Телефон пользователя. Указывается в формате ITU-T E.164 |
...
| public | [getInn()](YooKassa-Model-Supplier.md#method_getInn) |  | Возвращает ИНН пользователя (10 или 12 цифр) |
| public | [getName()](YooKassa-Model-Supplier.md#method_getName) |  | Возвращает наименование поставщика |
| public | [getPhone()](YooKassa-Model-Supplier.md#method_getPhone) |  | Возвращает Телефон пользователя. Указывается в формате ITU-T E.164 |
...
| public | [setInn()](YooKassa-Model-Supplier.md#method_setInn) |  | Устанавливает ИНН пользователя (10 или 12 цифр) |
| public | [setName()](YooKassa-Model-Supplier.md#method_setName) |  | Устанавливает наименование поставщика |
| public | [setPhone()](YooKassa-Model-Supplier.md#method_setPhone) |  | Устанавливает Телефон пользователя. Указывается в формате ITU-T E.164 |
...
* Implements:
  * [\YooKassa\Model\SupplierInterface](YooKassa-Model-SupplierInterface.md)
...
**Details:**
* Inherited From: [\YooKassa\Model\Supplier](YooKassa-Model-Supplier.md)
