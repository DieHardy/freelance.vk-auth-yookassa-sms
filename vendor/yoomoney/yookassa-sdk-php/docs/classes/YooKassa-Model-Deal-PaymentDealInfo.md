...
| ----------:| ---- | ---- | ------- |
| public | [$id](YooKassa-Model-Deal-PaymentDealInfo.md#property_id) |  | Идентификатор сделки |
| public | [$settlements](YooKassa-Model-Deal-PaymentDealInfo.md#property_settlements) |  | Данные о распределении денег |
...
| public | [addSettlement()](YooKassa-Model-Deal-PaymentDealInfo.md#method_addSettlement) |  | Добавляет оплату в чек |
...
| public | [getId()](YooKassa-Model-Deal-PaymentDealInfo.md#method_getId) |  | Возвращает Id сделки |
| public | [getSettlements()](YooKassa-Model-Deal-PaymentDealInfo.md#method_getSettlements) |  | Возвращает массив оплат, обеспечивающих выдачу товара |
...
| public | [setId()](YooKassa-Model-Deal-PaymentDealInfo.md#method_setId) |  | Устанавливает Id сделки |
| public | [setSettlements()](YooKassa-Model-Deal-PaymentDealInfo.md#method_setSettlements) |  | Возвращает массив оплат, обеспечивающих выдачу товара |
...
**Details:**
* Inherited From: [\YooKassa\Model\Deal\PaymentDealInfo](YooKassa-Model-Deal-PaymentDealInfo.md)
