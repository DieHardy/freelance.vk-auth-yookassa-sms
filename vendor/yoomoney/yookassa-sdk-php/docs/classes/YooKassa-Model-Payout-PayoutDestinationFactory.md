...
| ----------:| ---- | ---- | ------- |
| public | [factory()](YooKassa-Model-Payout-PayoutDestinationFactory.md#method_factory) |  | Фабричный метод создания объекта платежных данных по типу |
| public | [factoryFromArray()](YooKassa-Model-Payout-PayoutDestinationFactory.md#method_factoryFromArray) |  | Фабричный метод создания объекта платежных данных из массива |
...
**Details:**
* Inherited From: [\YooKassa\Model\Payout\PayoutDestinationFactory](YooKassa-Model-Payout-PayoutDestinationFactory.md)
