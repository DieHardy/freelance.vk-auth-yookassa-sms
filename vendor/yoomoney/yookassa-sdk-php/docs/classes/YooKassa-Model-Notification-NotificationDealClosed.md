...
| public | [$object](YooKassa-Model-Notification-NotificationDealClosed.md#property_object) |  | Объект с информацией о сделке |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-Notification-NotificationDealClosed.md#method___construct) |  | Конструктор объекта нотификации |
...
| public | [getObject()](YooKassa-Model-Notification-NotificationDealClosed.md#method_getObject) |  | Возвращает объект с информацией о сделке, уведомление о которой хранится в текущем объекте |
...
**Details:**
* Inherited From: [\YooKassa\Model\Notification\NotificationDealClosed](YooKassa-Model-Notification-NotificationDealClosed.md)
