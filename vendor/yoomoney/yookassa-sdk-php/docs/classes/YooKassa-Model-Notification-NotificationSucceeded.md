...
| public | [$object](YooKassa-Model-Notification-NotificationSucceeded.md#property_object) |  | Объект с информацией о платеже |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-Notification-NotificationSucceeded.md#method___construct) |  | Конструктор объекта нотификации о возможности подтверждения платежа |
...
| public | [getObject()](YooKassa-Model-Notification-NotificationSucceeded.md#method_getObject) |  | Возвращает объект с информацией о платеже, уведомление о котором хранится в текущем объекте |
...
**Details:**
* Inherited From: [\YooKassa\Model\Notification\NotificationSucceeded](YooKassa-Model-Notification-NotificationSucceeded.md)
