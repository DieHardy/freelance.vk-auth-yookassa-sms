...
| ----------:| ---- | ---- | ------- |
| public | [EXPIRED_BY_TIMEOUT](YooKassa-Model-PersonalData-PersonalDataCancellationDetailsReasonCode.md#constant_EXPIRED_BY_TIMEOUT) |  | Истек срок хранения или использования персональных данных. |

---
### Properties
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| protected | [$validValues](YooKassa-Model-PersonalData-PersonalDataCancellationDetailsReasonCode.md#property_validValues) |  |  |
