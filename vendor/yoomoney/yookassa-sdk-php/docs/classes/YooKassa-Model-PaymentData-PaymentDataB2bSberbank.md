...
| ----------:| ---- | ---- | ------- |
| public | [$paymentPurpose](YooKassa-Model-PaymentData-PaymentDataB2bSberbank.md#property_paymentPurpose) |  | Назначение платежа |
| public | [$type](YooKassa-Model-PaymentData-AbstractPaymentData.md#property_type) |  | Тип метода оплаты |
| public | [$vatData](YooKassa-Model-PaymentData-PaymentDataB2bSberbank.md#property_vatData) |  | Данные об НДС |

---
### Methods
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-PaymentData-PaymentDataB2bSberbank.md#method___construct) |  |  |
...
| public | [getPaymentPurpose()](YooKassa-Model-PaymentData-PaymentDataB2bSberbank.md#method_getPaymentPurpose) |  | Возвращает назначение платежа |
| public | [getType()](YooKassa-Model-PaymentData-AbstractPaymentData.md#method_getType) |  | Возвращает тип метода оплаты |
| public | [getVatData()](YooKassa-Model-PaymentData-PaymentDataB2bSberbank.md#method_getVatData) |  | Возвращает назначение платежа |
...
| public | [setPaymentPurpose()](YooKassa-Model-PaymentData-PaymentDataB2bSberbank.md#method_setPaymentPurpose) |  | Устанавливает назначение платежа |
| public | [setVatData()](YooKassa-Model-PaymentData-PaymentDataB2bSberbank.md#method_setVatData) |  | Устанавливает назначение платежа |
...
**Details:**
* Inherited From: [\YooKassa\Model\PaymentData\PaymentDataB2bSberbank](YooKassa-Model-PaymentData-PaymentDataB2bSberbank.md)
