...
| ----------:| ---- | ---- | ------- |
| public | [$card](YooKassa-Model-PaymentData-PaymentDataBankCard.md#property_card) |  | Данные банковской карты |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-PaymentData-PaymentDataBankCard.md#method___construct) |  |  |
...
| public | [getCard()](YooKassa-Model-PaymentData-PaymentDataBankCard.md#method_getCard) |  | Возвращает данные банковской карты |
...
| public | [setCard()](YooKassa-Model-PaymentData-PaymentDataBankCard.md#method_setCard) |  | Устанавливает данные банковской карты |
...
**Details:**
* Inherited From: [\YooKassa\Model\PaymentData\PaymentDataBankCard](YooKassa-Model-PaymentData-PaymentDataBankCard.md)
