...
| ----------:| ---- | ---- | ------- |
| public | [$confirmation_url](YooKassa-Model-SelfEmployed-SelfEmployedConfirmationRedirect.md#property_confirmation_url) |  | URL на который необходимо перенаправить плательщика для подтверждения оплаты |
| public | [$confirmationUrl](YooKassa-Model-SelfEmployed-SelfEmployedConfirmationRedirect.md#property_confirmationUrl) |  | URL на который необходимо перенаправить плательщика для подтверждения оплаты |
| public | [$type](YooKassa-Model-SelfEmployed-SelfEmployedConfirmation.md#property_type) |  | Тип сценария подтверждения. |

---
### Methods
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-SelfEmployed-SelfEmployedConfirmationRedirect.md#method___construct) |  |  |
...
| public | [getConfirmationUrl()](YooKassa-Model-SelfEmployed-SelfEmployedConfirmationRedirect.md#method_getConfirmationUrl) |  | Возвращает confirmation_url. |
| public | [getType()](YooKassa-Model-SelfEmployed-SelfEmployedConfirmation.md#method_getType) |  | Возвращает тип сценария подтверждения |
...
| public | [setConfirmationUrl()](YooKassa-Model-SelfEmployed-SelfEmployedConfirmationRedirect.md#method_setConfirmationUrl) |  | Устанавливает confirmation_url. |
...
| protected | [setType()](YooKassa-Model-SelfEmployed-SelfEmployedConfirmation.md#method_setType) |  | Устанавливает тип сценария подтверждения |
...
* Class Hierarchy:  
  ...
  * [\YooKassa\Model\SelfEmployed\SelfEmployedConfirmation](YooKassa-Model-SelfEmployed-SelfEmployedConfirmation.md)
...
**Details:**
* Inherited From: [\YooKassa\Model\SelfEmployed\SelfEmployedConfirmation](YooKassa-Model-SelfEmployed-SelfEmployedConfirmation.md)
...
**Details:**
* Inherited From: [\YooKassa\Model\SelfEmployed\SelfEmployedConfirmationRedirect](YooKassa-Model-SelfEmployed-SelfEmployedConfirmationRedirect.md)
