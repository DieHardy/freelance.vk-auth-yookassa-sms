...
| public | [SDK_VERSION](YooKassa-Client.md#constant_SDK_VERSION) |  | Текущая версия библиотеки |
...
| public | [addWebhook()](YooKassa-Client.md#method_addWebhook) |  | Создание Webhook |
| public | [cancelPayment()](YooKassa-Client.md#method_cancelPayment) |  | Отменить незавершенную оплату заказа. |
| public | [capturePayment()](YooKassa-Client.md#method_capturePayment) |  | Подтверждение платежа |
| public | [createDeal()](YooKassa-Client.md#method_createDeal) |  | Создание сделки. |
| public | [createPayment()](YooKassa-Client.md#method_createPayment) |  | Создание платежа. |
| public | [createPayout()](YooKassa-Client.md#method_createPayout) |  | Создание выплаты. |
| public | [createPersonalData()](YooKassa-Client.md#method_createPersonalData) |  | Создание персональных данных |
| public | [createReceipt()](YooKassa-Client.md#method_createReceipt) |  | Отправка чека в облачную кассу |
| public | [createRefund()](YooKassa-Client.md#method_createRefund) |  | Проведение возврата платежа |
| public | [createSelfEmployed()](YooKassa-Client.md#method_createSelfEmployed) |  | Создание самозанятого. |
...
| public | [getDealInfo()](YooKassa-Client.md#method_getDealInfo) |  | Получить информацию о сделке |
| public | [getDeals()](YooKassa-Client.md#method_getDeals) |  | Получить список сделок магазина |
| public | [getPaymentInfo()](YooKassa-Client.md#method_getPaymentInfo) |  | Получить информацию о платеже |
| public | [getPayments()](YooKassa-Client.md#method_getPayments) |  | Получить список платежей магазина |
| public | [getPayoutInfo()](YooKassa-Client.md#method_getPayoutInfo) |  | Получить информацию о выплате |
| public | [getPersonalDataInfo()](YooKassa-Client.md#method_getPersonalDataInfo) |  | Получить информацию о персональных данных |
| public | [getReceiptInfo()](YooKassa-Client.md#method_getReceiptInfo) |  | Получить информацию о чеке |
| public | [getReceipts()](YooKassa-Client.md#method_getReceipts) |  | Получить список чеков магазина |
| public | [getRefundInfo()](YooKassa-Client.md#method_getRefundInfo) |  | Получить информацию о возврате |
| public | [getRefunds()](YooKassa-Client.md#method_getRefunds) |  | Получить список возвратов платежей |
| public | [getSbpBanks()](YooKassa-Client.md#method_getSbpBanks) |  | Получить список участников СБП |
| public | [getSelfEmployedInfo()](YooKassa-Client.md#method_getSelfEmployedInfo) |  | Получить информацию о самозанятом |
| public | [getWebhooks()](YooKassa-Client.md#method_getWebhooks) |  | Список созданных Webhook |
...
| public | [me()](YooKassa-Client.md#method_me) |  | Информация о магазине |
| public | [removeWebhook()](YooKassa-Client.md#method_removeWebhook) |  | Удаление Webhook |
...
* Package: YooKassa
* Class Hierarchy: 
  * [\YooKassa\Client\BaseClient](YooKassa-Client-BaseClient.md)
  * \YooKassa\Client
...
**Details:**
* Inherited From: [\YooKassa\Client](YooKassa-Client.md)
    ...
    do {
        ...
        foreach ($deals->getItems() as $deal) {
            $res = array(
                ...
                $deal->getBalance()->getValue() . ' YooKassa-Client.md' . $deal->getBalance()->getCurrency(),
                $deal->getPayoutBalance()->getValue() . ' YooKassa-Client.md' . $deal->getBalance()->getCurrency(),
                $deal->getStatus(),
                $deal->getId(),
            );
            echo implode(' - ', $res) . "\n";
