...
| ----------:| ---- | ---- | ------- |
| public | [$amount](YooKassa-Model-PaymentData-B2b-Sberbank-VatData.md#property_amount) |  | Сумма НДС |
| public | [$rate](YooKassa-Model-PaymentData-B2b-Sberbank-VatData.md#property_rate) |  | Данные об НДС в случае, если сумма НДС включена в сумму платежа |
| public | [$type](YooKassa-Model-PaymentData-B2b-Sberbank-VatData.md#property_type) |  | Способ расчёта НДС |

---
### Methods
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-PaymentData-B2b-Sberbank-VatData.md#method___construct) |  | VatData constructor. |
...
| public | [getAmount()](YooKassa-Model-PaymentData-B2b-Sberbank-VatData.md#method_getAmount) |  | Возвращает сумму НДС |
| public | [getRate()](YooKassa-Model-PaymentData-B2b-Sberbank-VatData.md#method_getRate) |  | Возвращает налоговую ставку НДС |
| public | [getType()](YooKassa-Model-PaymentData-B2b-Sberbank-VatData.md#method_getType) |  | Возвращает способ расчёта НДС |
...
| public | [setAmount()](YooKassa-Model-PaymentData-B2b-Sberbank-VatData.md#method_setAmount) |  | Устанавливает сумму НДС |
| public | [setRate()](YooKassa-Model-PaymentData-B2b-Sberbank-VatData.md#method_setRate) |  | Устанавливает налоговую ставку НДС |
| public | [setType()](YooKassa-Model-PaymentData-B2b-Sberbank-VatData.md#method_setType) |  | Устанавливает способ расчёта НДС |
...
* Implements:
  * [\YooKassa\Model\PaymentData\B2b\Sberbank\VatDataInterface](YooKassa-Model-PaymentData-B2b-Sberbank-VatDataInterface.md)
...
**Details:**
* Inherited From: [\YooKassa\Model\PaymentData\B2b\Sberbank\VatData](YooKassa-Model-PaymentData-B2b-Sberbank-VatData.md)
