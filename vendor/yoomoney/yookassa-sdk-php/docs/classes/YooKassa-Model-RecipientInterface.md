...
| ----------:| ---- | ---- | ------- |
| public | [getAccountId()](YooKassa-Model-RecipientInterface.md#method_getAccountId) |  | Возвращает идентификатор магазина |
| public | [getGatewayId()](YooKassa-Model-RecipientInterface.md#method_getGatewayId) |  | Возвращает идентификатор шлюза. |
...
**Details:**
* Inherited From: [\YooKassa\Model\RecipientInterface](YooKassa-Model-RecipientInterface.md)
