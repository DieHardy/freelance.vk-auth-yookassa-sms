...
| ----------:| ---- | ---- | ------- |
| public | [PAYMENT_SUCCEEDED](YooKassa-Model-Deal-FeeMoment.md#constant_PAYMENT_SUCCEEDED) |  | Вознаграждение после успешной оплаты |
| public | [DEAL_CLOSED](YooKassa-Model-Deal-FeeMoment.md#constant_DEAL_CLOSED) |  | Вознаграждение при закрытии сделки после успешной выплаты |

---
### Properties
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| protected | [$validValues](YooKassa-Model-Deal-FeeMoment.md#property_validValues) |  |  |
