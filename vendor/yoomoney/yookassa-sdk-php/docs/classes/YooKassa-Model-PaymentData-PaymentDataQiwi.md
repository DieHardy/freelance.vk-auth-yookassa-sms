...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-PaymentData-PaymentDataQiwi.md#method___construct) |  |  |
...
| public | [getPhone()](YooKassa-Model-PaymentData-PaymentDataQiwi.md#method_getPhone) |  | Возвращает номер телефона в формате ITU-T E.164 |
...
| public | [setPhone()](YooKassa-Model-PaymentData-PaymentDataQiwi.md#method_setPhone) |  | Устанавливает номер телефона в формате ITU-T E.164 |
...
**Details:**
* Inherited From: [\YooKassa\Model\PaymentData\PaymentDataQiwi](YooKassa-Model-PaymentData-PaymentDataQiwi.md)
