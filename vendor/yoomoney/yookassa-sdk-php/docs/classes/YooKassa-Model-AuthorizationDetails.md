...
| ----------:| ---- | ---- | ------- |
| public | [$authCode](YooKassa-Model-AuthorizationDetails.md#property_authCode) |  | Код авторизации банковской карты |
| public | [$rrn](YooKassa-Model-AuthorizationDetails.md#property_rrn) |  | Retrieval Reference Number — уникальный идентификатор транзакции в системе эмитента |
| public | [$threeDSecure](YooKassa-Model-AuthorizationDetails.md#property_threeDSecure) |  | Данные о прохождении пользователем аутентификации по 3‑D Secure |
...
| public | [fromArray()](YooKassa-Model-AuthorizationDetails.md#method_fromArray) |  | Устанавливает значения свойств текущего объекта из массива |
| public | [getAuthCode()](YooKassa-Model-AuthorizationDetails.md#method_getAuthCode) |  | Возвращает код авторизации банковской карты |
| public | [getRrn()](YooKassa-Model-AuthorizationDetails.md#method_getRrn) |  | Возвращает уникальный идентификатор транзакции |
| public | [getThreeDSecure()](YooKassa-Model-AuthorizationDetails.md#method_getThreeDSecure) |  | Возвращает данные о прохождении пользователем аутентификации по 3‑D Secure |
...
| public | [setAuthCode()](YooKassa-Model-AuthorizationDetails.md#method_setAuthCode) |  | Устанавливает код авторизации банковской карты |
| public | [setRrn()](YooKassa-Model-AuthorizationDetails.md#method_setRrn) |  | Устанавливает уникальный идентификатор транзакции |
| public | [setThreeDSecure()](YooKassa-Model-AuthorizationDetails.md#method_setThreeDSecure) |  | Устанавливает данные о прохождении пользователем аутентификации по 3‑D Secure |
...
* Implements:
  * [\YooKassa\Model\AuthorizationDetailsInterface](YooKassa-Model-AuthorizationDetailsInterface.md)
...
**Details:**
* Inherited From: [\YooKassa\Model\AuthorizationDetails](YooKassa-Model-AuthorizationDetails.md)
