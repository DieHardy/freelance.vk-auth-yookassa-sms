...
| ----------:| ---- | ---- | ------- |
| public | [HTTP_CODE](YooKassa-Common-Exceptions-ResponseProcessingException.md#constant_HTTP_CODE) |  |  |

---
### Properties
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [$retryAfter](YooKassa-Common-Exceptions-ResponseProcessingException.md#property_retryAfter) |  |  |
| public | [$type](YooKassa-Common-Exceptions-ResponseProcessingException.md#property_type) |  |  |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Common-Exceptions-ResponseProcessingException.md#method___construct) |  | Constructor |
...
**Details:**
* Inherited From: [\YooKassa\Common\Exceptions\ResponseProcessingException](YooKassa-Common-Exceptions-ResponseProcessingException.md)
