...
| ----------:| ---- | ---- | ------- |
| public | [factory()](YooKassa-Request-Receipts-ReceiptResponseFactory.md#method_factory) |  | Фабричный метод для работы с чеками |
...
**Details:**
* Inherited From: [\YooKassa\Request\Receipts\ReceiptResponseFactory](YooKassa-Request-Receipts-ReceiptResponseFactory.md)
