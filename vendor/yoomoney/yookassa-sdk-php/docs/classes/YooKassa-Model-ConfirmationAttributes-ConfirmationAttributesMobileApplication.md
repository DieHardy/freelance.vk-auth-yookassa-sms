...
| ----------:| ---- | ---- | ------- |
| public | [$return_url](YooKassa-Model-ConfirmationAttributes-ConfirmationAttributesMobileApplication.md#property_return_url) |  | URL на который вернется плательщик после подтверждения или отмены платежа на странице партнера. |
| public | [$returnUrl](YooKassa-Model-ConfirmationAttributes-ConfirmationAttributesMobileApplication.md#property_returnUrl) |  | URL на который вернется плательщик после подтверждения или отмены платежа на странице партнера. |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-ConfirmationAttributes-ConfirmationAttributesMobileApplication.md#method___construct) |  |  |
...
| public | [getReturnUrl()](YooKassa-Model-ConfirmationAttributes-ConfirmationAttributesMobileApplication.md#method_getReturnUrl) |  |  |
...
| public | [setReturnUrl()](YooKassa-Model-ConfirmationAttributes-ConfirmationAttributesMobileApplication.md#method_setReturnUrl) |  |  |
...
**Details:**
* Inherited From: [\YooKassa\Model\ConfirmationAttributes\ConfirmationAttributesMobileApplication](YooKassa-Model-ConfirmationAttributes-ConfirmationAttributesMobileApplication.md)
