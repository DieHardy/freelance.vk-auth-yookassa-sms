...
| ----------:| ---- | ---- | ------- |
| public | [serialize()](YooKassa-Request-Deals-CreateDealRequestSerializer.md#method_serialize) |  | Формирует ассоциативный массив данных из объекта запроса |
...
**Details:**
* Inherited From: [\YooKassa\Request\Deals\CreateDealRequestSerializer](YooKassa-Request-Deals-CreateDealRequestSerializer.md)
