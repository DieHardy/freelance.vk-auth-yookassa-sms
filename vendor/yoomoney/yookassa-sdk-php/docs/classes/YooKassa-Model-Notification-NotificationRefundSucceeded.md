...
| public | [$object](YooKassa-Model-Notification-NotificationRefundSucceeded.md#property_object) |  | Объект с информацией о возврате |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-Notification-NotificationRefundSucceeded.md#method___construct) |  | Конструктор объекта нотификации |
...
| public | [getObject()](YooKassa-Model-Notification-NotificationRefundSucceeded.md#method_getObject) |  | Возвращает объект с информацией о возврате, уведомление о котором хранится в текущем объекте |
...
**Details:**
* Inherited From: [\YooKassa\Model\Notification\NotificationRefundSucceeded](YooKassa-Model-Notification-NotificationRefundSucceeded.md)
