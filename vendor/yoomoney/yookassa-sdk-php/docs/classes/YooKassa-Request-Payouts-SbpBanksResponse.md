...
| public | [fromArray()](YooKassa-Request-Payouts-SbpBanksResponse.md#method_fromArray) |  | Конструктор, устанавливает свойства объекта из пришедшего из API ассоциативного массива |
| public | [getItems()](YooKassa-Request-Payouts-SbpBanksResponse.md#method_getItems) |  | Возвращает items. |
| public | [getType()](YooKassa-Request-Payouts-SbpBanksResponse.md#method_getType) |  | Возвращает type. |
...
| public | [setType()](YooKassa-Request-Payouts-SbpBanksResponse.md#method_setType) |  | Устанавливает type. |
...
**Details:**
* Inherited From: [\YooKassa\Request\Payouts\SbpBanksResponse](YooKassa-Request-Payouts-SbpBanksResponse.md)
