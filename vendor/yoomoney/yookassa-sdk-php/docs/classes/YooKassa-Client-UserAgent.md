...
| ----------:| ---- | ---- | ------- |
| public | [HEADER](YooKassa-Client-UserAgent.md#constant_HEADER) |  | Имя заголовка для User-Agent |
| public | [VERSION_DELIMITER](YooKassa-Client-UserAgent.md#constant_VERSION_DELIMITER) |  | Разделитель части заголовка и её версии |
| public | [PART_DELIMITER](YooKassa-Client-UserAgent.md#constant_PART_DELIMITER) |  | Разделитель между частями заголовка |

---
### Methods
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Client-UserAgent.md#method___construct) |  | Конструктор UserAgent |
| public | [createVersion()](YooKassa-Client-UserAgent.md#method_createVersion) |  | Создание строки версии компонента |
| public | [getCms()](YooKassa-Client-UserAgent.md#method_getCms) |  | Возвращает версию CMS |
| public | [getFramework()](YooKassa-Client-UserAgent.md#method_getFramework) |  | Возвращает версию фреймворка |
| public | [getHeaderString()](YooKassa-Client-UserAgent.md#method_getHeaderString) |  | Формирует конечную строку из составных частей |
| public | [getModule()](YooKassa-Client-UserAgent.md#method_getModule) |  | Возвращает версию модуля |
| public | [getOs()](YooKassa-Client-UserAgent.md#method_getOs) |  | Возвращает версию операционной системы |
| public | [getPhp()](YooKassa-Client-UserAgent.md#method_getPhp) |  | Возвращает версию PHP |
| public | [getSdk()](YooKassa-Client-UserAgent.md#method_getSdk) |  | Возвращает версию SDK |
| public | [setCms()](YooKassa-Client-UserAgent.md#method_setCms) |  | Устанавливает версию CMS |
| public | [setFramework()](YooKassa-Client-UserAgent.md#method_setFramework) |  | Устанавливает версию фреймворка |
| public | [setModule()](YooKassa-Client-UserAgent.md#method_setModule) |  | Устанавливает версию модуля |
...
**Details:**
* Inherited From: [\YooKassa\Client\UserAgent](YooKassa-Client-UserAgent.md)
