...
| ----------:| ---- | ---- | ------- |
| public | [$currency](YooKassa-Model-Deal-DealBalanceAmount.md#property_currency) |  | Код валюты |
| public | [$value](YooKassa-Model-Deal-DealBalanceAmount.md#property_value) |  | Сумма |

---
### Methods
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-Deal-DealBalanceAmount.md#method___construct) |  | MonetaryAmount constructor. |
...
| public | [getCurrency()](YooKassa-Model-Deal-DealBalanceAmount.md#method_getCurrency) |  | Возвращает валюту |
| public | [getIntegerValue()](YooKassa-Model-Deal-DealBalanceAmount.md#method_getIntegerValue) |  | Возвращает сумму в копейках в виде целого числа |
| public | [getValue()](YooKassa-Model-Deal-DealBalanceAmount.md#method_getValue) |  | Возвращает значение суммы |
| public | [jsonSerialize()](YooKassa-Model-Deal-DealBalanceAmount.md#method_jsonSerialize) |  | Возвращает ассоциативный массив со свойствами текущего объекта для его дальнейшей JSON сериализации |
...
| public | [setCurrency()](YooKassa-Model-Deal-DealBalanceAmount.md#method_setCurrency) |  | Устанавливает код валюты |
| public | [setValue()](YooKassa-Model-Deal-DealBalanceAmount.md#method_setValue) |  | Устанавливает сумму |
...
**Details:**
* Inherited From: [\YooKassa\Model\Deal\DealBalanceAmount](YooKassa-Model-Deal-DealBalanceAmount.md)
