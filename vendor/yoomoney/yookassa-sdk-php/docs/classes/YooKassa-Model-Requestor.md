...
| ----------:| ---- | ---- | ------- |
| public | [$account_id](YooKassa-Model-Requestor.md#property_account_id) |  | Идентификатор магазина |
| public | [$accountId](YooKassa-Model-Requestor.md#property_accountId) |  | Идентификатор магазина |
| public | [$client_id](YooKassa-Model-Requestor.md#property_client_id) |  | Идентификатор приложения |
| public | [$client_name](YooKassa-Model-Requestor.md#property_client_name) |  | Название приложения (только для type = RequestorThirdPartyService) |
| public | [$clientId](YooKassa-Model-Requestor.md#property_clientId) |  | Идентификатор приложения |
| public | [$clientName](YooKassa-Model-Requestor.md#property_clientName) |  | Название приложения (только для type = RequestorThirdPartyService) |
| public | [$type](YooKassa-Model-Requestor.md#property_type) |  | Тип инициатора |
...
| public | [getAccountId()](YooKassa-Model-Requestor.md#method_getAccountId) |  | Возвращает идентификатор магазина |
| public | [getClientId()](YooKassa-Model-Requestor.md#method_getClientId) |  | Возвращает идентификатор приложения |
| public | [getClientName()](YooKassa-Model-Requestor.md#method_getClientName) |  | Возвращает название приложения |
| public | [getType()](YooKassa-Model-Requestor.md#method_getType) |  | Возвращает тип инициатора |
...
| public | [setAccountId()](YooKassa-Model-Requestor.md#method_setAccountId) |  | Устанавливает идентификатор магазина |
| public | [setClientId()](YooKassa-Model-Requestor.md#method_setClientId) |  | Устанавливает идентификатор приложения |
| public | [setClientName()](YooKassa-Model-Requestor.md#method_setClientName) |  | Устанавливает название приложения |
| public | [setType()](YooKassa-Model-Requestor.md#method_setType) |  | Устанавливает тип инициатора |
...
* Implements:
  * [\YooKassa\Model\RequestorInterface](YooKassa-Model-RequestorInterface.md)
...
**Details:**
* Inherited From: [\YooKassa\Model\Requestor](YooKassa-Model-Requestor.md)
