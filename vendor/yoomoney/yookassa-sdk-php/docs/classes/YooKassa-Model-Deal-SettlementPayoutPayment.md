...
| ----------:| ---- | ---- | ------- |
| public | [$amount](YooKassa-Model-Deal-SettlementPayoutPayment.md#property_amount) |  | Размер оплаты |
| public | [$type](YooKassa-Model-Deal-SettlementPayoutPayment.md#property_type) |  | Вид оплаты в чеке |
...
| public | [getAmount()](YooKassa-Model-Deal-SettlementPayoutPayment.md#method_getAmount) |  | Возвращает размер оплаты |
| public | [getType()](YooKassa-Model-Deal-SettlementPayoutPayment.md#method_getType) |  | Возвращает тип операции (payout - выплата продавцу) |
...
| public | [setAmount()](YooKassa-Model-Deal-SettlementPayoutPayment.md#method_setAmount) |  | Устанавливает сумму платежа |
| public | [setType()](YooKassa-Model-Deal-SettlementPayoutPayment.md#method_setType) |  | Устанавливает вид оплаты в чеке |
...
**Details:**
* Inherited From: [\YooKassa\Model\Deal\SettlementPayoutPayment](YooKassa-Model-Deal-SettlementPayoutPayment.md)
