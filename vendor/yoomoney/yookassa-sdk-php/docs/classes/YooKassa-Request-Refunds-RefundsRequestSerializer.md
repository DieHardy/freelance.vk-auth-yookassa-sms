...
| ----------:| ---- | ---- | ------- |
| public | [serialize()](YooKassa-Request-Refunds-RefundsRequestSerializer.md#method_serialize) |  | Сериализует объект запроса к API для дальнейшей его отправки |
...
**Details:**
* Inherited From: [\YooKassa\Request\Refunds\RefundsRequestSerializer](YooKassa-Request-Refunds-RefundsRequestSerializer.md)
