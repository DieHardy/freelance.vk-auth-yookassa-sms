...
| ----------:| ---- | ---- | ------- |
| public | [$account_id](YooKassa-Model-Recipient.md#property_account_id) |  | Идентификатор магазина |
| public | [$accountId](YooKassa-Model-Recipient.md#property_accountId) |  | Идентификатор магазина |
| public | [$gateway_id](YooKassa-Model-Recipient.md#property_gateway_id) |  | Идентификатор шлюза |
| public | [$gatewayId](YooKassa-Model-Recipient.md#property_gatewayId) |  | Идентификатор шлюза |
...
| public | [getAccountId()](YooKassa-Model-Recipient.md#method_getAccountId) |  | Возвращает идентификатор магазина |
| public | [getGatewayId()](YooKassa-Model-Recipient.md#method_getGatewayId) |  | Возвращает идентификатор шлюза. |
...
| public | [setAccountId()](YooKassa-Model-Recipient.md#method_setAccountId) |  | Устанавливает идентификатор магазина |
| public | [setGatewayId()](YooKassa-Model-Recipient.md#method_setGatewayId) |  | Устанавливает идентификатор шлюза |
...
* Implements:
  * [\YooKassa\Model\RecipientInterface](YooKassa-Model-RecipientInterface.md)
...
**Details:**
* Inherited From: [\YooKassa\Model\Recipient](YooKassa-Model-Recipient.md)
