...
| public | [count()](YooKassa-Model-Metadata.md#method_count) |  | Возвращает количество метаданных |
...
| public | [getIterator()](YooKassa-Model-Metadata.md#method_getIterator) |  | Возвращает объект ArrayIterator для метаданных |
...
| public | [toArray()](YooKassa-Model-Metadata.md#method_toArray) |  | Возвращает ассоциативный массив со свойствами текущего объекта для его дальнейшей JSON сериализации Является алиасом метода AbstractObject::jsonSerialize() |
...
**Details:**
* Inherited From: [\YooKassa\Model\Metadata](YooKassa-Model-Metadata.md)
