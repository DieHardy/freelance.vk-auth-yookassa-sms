...
| ----------:| ---- | ---- | ------- |
| public | [$id](YooKassa-Model-Payout-PayoutSelfEmployed.md#property_id) |  | Идентификатор самозанятого в ЮKassa. |
...
| public | [getId()](YooKassa-Model-Payout-PayoutSelfEmployed.md#method_getId) |  | Возвращает идентификатор самозанятого в ЮKassa. |
...
| public | [setId()](YooKassa-Model-Payout-PayoutSelfEmployed.md#method_setId) |  | Устанавливает идентификатор самозанятого в ЮKassa. |
...
**Details:**
* Inherited From: [\YooKassa\Model\Payout\PayoutSelfEmployed](YooKassa-Model-Payout-PayoutSelfEmployed.md)
