...
| ----------:| ---- | ---- | ------- |
| public | [$currency](YooKassa-Model-MonetaryAmount.md#property_currency) |  | Код валюты |
| public | [$value](YooKassa-Model-MonetaryAmount.md#property_value) |  | Сумма |

---
### Methods
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-MonetaryAmount.md#method___construct) |  | MonetaryAmount constructor. |
...
| public | [getCurrency()](YooKassa-Model-MonetaryAmount.md#method_getCurrency) |  | Возвращает валюту |
| public | [getIntegerValue()](YooKassa-Model-MonetaryAmount.md#method_getIntegerValue) |  | Возвращает сумму в копейках в виде целого числа |
| public | [getValue()](YooKassa-Model-MonetaryAmount.md#method_getValue) |  | Возвращает значение суммы |
| public | [increase()](YooKassa-Model-MonetaryAmount.md#method_increase) |  | Увеличивает сумму на указанное значение |
| public | [jsonSerialize()](YooKassa-Model-MonetaryAmount.md#method_jsonSerialize) |  | Возвращает ассоциативный массив со свойствами текущего объекта для его дальнейшей JSON сериализации |
| public | [multiply()](YooKassa-Model-MonetaryAmount.md#method_multiply) |  | Умножает текущую сумму на указанный коэффициент |
...
| public | [setCurrency()](YooKassa-Model-MonetaryAmount.md#method_setCurrency) |  | Устанавливает код валюты |
| public | [setValue()](YooKassa-Model-MonetaryAmount.md#method_setValue) |  | Устанавливает сумму |
...
**Details:**
* Inherited From: [\YooKassa\Model\MonetaryAmount](YooKassa-Model-MonetaryAmount.md)
