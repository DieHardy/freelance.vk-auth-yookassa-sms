...
| public | [$amount](YooKassa-Request-Payments-Payment-CreateCaptureRequest.md#property_amount) |  | Подтверждаемая сумма оплаты |
| public | [$amount](YooKassa-Common-AbstractPaymentRequest.md#property_amount) |  | Сумма |
| public | [$deal](YooKassa-Request-Payments-Payment-CreateCaptureRequest.md#property_deal) |  | Данные о сделке, в составе которой проходит платеж |
| public | [$receipt](YooKassa-Request-Payments-Payment-CreateCaptureRequest.md#property_receipt) |  | Данные фискального чека 54-ФЗ |
...
| public | [builder()](YooKassa-Request-Payments-Payment-CreateCaptureRequest.md#method_builder) |  | Возвращает билдер объектов запросов на подтверждение оплаты |
...
| public | [getDeal()](YooKassa-Request-Payments-Payment-CreateCaptureRequest.md#method_getDeal) |  | Возвращает данные о сделке, в составе которой проходит платеж |
...
| public | [hasDeal()](YooKassa-Request-Payments-Payment-CreateCaptureRequest.md#method_hasDeal) |  | Проверяет, были ли установлены данные о сделке |
...
| public | [setDeal()](YooKassa-Request-Payments-Payment-CreateCaptureRequest.md#method_setDeal) |  | Устанавливает данные о сделке, в составе которой проходит платеж. |
...
| public | [validate()](YooKassa-Request-Payments-Payment-CreateCaptureRequest.md#method_validate) |  | Валидирует объект запроса |
...
* Implements:
  * [\YooKassa\Request\Payments\Payment\CreateCaptureRequestInterface](YooKassa-Request-Payments-Payment-CreateCaptureRequestInterface.md)
...
**Details:**
* Inherited From: [\YooKassa\Request\Payments\Payment\CreateCaptureRequest](YooKassa-Request-Payments-Payment-CreateCaptureRequest.md)
