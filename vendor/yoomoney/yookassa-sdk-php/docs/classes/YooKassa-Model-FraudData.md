...
| ----------:| ---- | ---- | ------- |
| public | [$topped_up_phone](YooKassa-Model-FraudData.md#property_topped_up_phone) |  | Номер телефона для пополнения |
| public | [$toppedUpPhone](YooKassa-Model-FraudData.md#property_toppedUpPhone) |  | Номер телефона для пополнения |
...
| public | [getToppedUpPhone()](YooKassa-Model-FraudData.md#method_getToppedUpPhone) |  | Возвращает номер телефона для пополнения. |
...
| public | [setToppedUpPhone()](YooKassa-Model-FraudData.md#method_setToppedUpPhone) |  | Устанавливает номер телефона для пополнения. |
...
**Details:**
* Inherited From: [\YooKassa\Model\FraudData](YooKassa-Model-FraudData.md)
