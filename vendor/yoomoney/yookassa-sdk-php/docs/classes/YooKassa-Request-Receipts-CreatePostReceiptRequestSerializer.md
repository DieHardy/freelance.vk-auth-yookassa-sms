...
| ----------:| ---- | ---- | ------- |
| public | [serialize()](YooKassa-Request-Receipts-CreatePostReceiptRequestSerializer.md#method_serialize) |  | Сериализует объект запроса к API для дальнейшей его отправки |
...
**Details:**
* Inherited From: [\YooKassa\Request\Receipts\CreatePostReceiptRequestSerializer](YooKassa-Request-Receipts-CreatePostReceiptRequestSerializer.md)
