...
| ----------:| ---- | ---- | ------- |
| public | [$account_number](YooKassa-Model-PaymentMethod-PaymentMethodYooMoney.md#property_account_number) |  | Номер кошелька в ЮMoney, с которого была произведена оплата |
| public | [$accountNumber](YooKassa-Model-PaymentMethod-PaymentMethodYooMoney.md#property_accountNumber) |  | Номер кошелька в ЮMoney, с которого была произведена оплата |
...
| public | [$type](YooKassa-Model-PaymentMethod-PaymentMethodYooMoney.md#property_type) |  | Тип объекта |

---
### Methods
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-PaymentMethod-PaymentMethodYooMoney.md#method___construct) |  |  |
...
| public | [getAccountNumber()](YooKassa-Model-PaymentMethod-PaymentMethodYooMoney.md#method_getAccountNumber) |  | Возвращает номер кошелька в ЮMoney, с которого была произведена оплата |
...
| public | [setAccountNumber()](YooKassa-Model-PaymentMethod-PaymentMethodYooMoney.md#method_setAccountNumber) |  | Устанавливает номер кошелька в ЮMoney, с которого была произведена оплата |
...
**Details:**
* Inherited From: [\YooKassa\Model\PaymentMethod\PaymentMethodYooMoney](YooKassa-Model-PaymentMethod-PaymentMethodYooMoney.md)
