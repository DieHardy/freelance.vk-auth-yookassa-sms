...
| public | [getObject()](YooKassa-Model-Notification-AbstractNotification.md#method_getObject) |  | Возвращает объект с информацией о платеже или возврате, уведомление о котором хранится в текущем объекте |
...
* Implements:
  * [\YooKassa\Model\Notification\NotificationInterface](YooKassa-Model-Notification-NotificationInterface.md)
