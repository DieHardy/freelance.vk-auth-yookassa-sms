...
| ----------:| ---- | ---- | ------- |
| public | [getParty()](YooKassa-Model-CancellationDetailsInterface.md#method_getParty) |  | Возвращает участника процесса платежа, который принял решение об отмене транзакции |
| public | [getReason()](YooKassa-Model-CancellationDetailsInterface.md#method_getReason) |  | Возвращает причину отмены платежа |
...
**Details:**
* Inherited From: [\YooKassa\Model\CancellationDetailsInterface](YooKassa-Model-CancellationDetailsInterface.md)
