...
| ----------:| ---- | ---- | ------- |
| public | [$first_name](YooKassa-Model-Passenger.md#property_first_name) |  | Имя пассажира |
| public | [$firstName](YooKassa-Model-Passenger.md#property_firstName) |  | Имя пассажира |
| public | [$last_name](YooKassa-Model-Passenger.md#property_last_name) |  | Фамилия пассажира |
| public | [$lastName](YooKassa-Model-Passenger.md#property_lastName) |  | Фамилия пассажира |
...
| public | [getFirstName()](YooKassa-Model-Passenger.md#method_getFirstName) |  | Возвращает имя пассажира |
| public | [getLastName()](YooKassa-Model-Passenger.md#method_getLastName) |  | Возвращает фамилию пассажира |
...
| public | [setFirstName()](YooKassa-Model-Passenger.md#method_setFirstName) |  | Устанавливает имя пассажира |
| public | [setLastName()](YooKassa-Model-Passenger.md#method_setLastName) |  | Устанавливает фамилию пассажира |
...
* Implements:
  * [\YooKassa\Model\PassengerInterface](YooKassa-Model-PassengerInterface.md)
...
**Details:**
* Inherited From: [\YooKassa\Model\Passenger](YooKassa-Model-Passenger.md)
