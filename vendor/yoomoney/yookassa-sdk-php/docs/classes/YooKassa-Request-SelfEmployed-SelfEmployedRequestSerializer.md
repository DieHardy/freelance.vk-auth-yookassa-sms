...
| ----------:| ---- | ---- | ------- |
| public | [serialize()](YooKassa-Request-SelfEmployed-SelfEmployedRequestSerializer.md#method_serialize) |  | Формирует ассоциативный массив данных из объекта запроса |
...
**Details:**
* Inherited From: [\YooKassa\Request\SelfEmployed\SelfEmployedRequestSerializer](YooKassa-Request-SelfEmployed-SelfEmployedRequestSerializer.md)
