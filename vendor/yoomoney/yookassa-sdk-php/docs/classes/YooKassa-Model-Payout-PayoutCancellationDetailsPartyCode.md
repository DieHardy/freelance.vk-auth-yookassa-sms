...
| ----------:| ---- | ---- | ------- |
| public | [MERCHANT](YooKassa-Model-Payout-PayoutCancellationDetailsPartyCode.md#constant_MERCHANT) | *deprecated* | Платформа (вы) |
| public | [YOO_KASSA](YooKassa-Model-Payout-PayoutCancellationDetailsPartyCode.md#constant_YOO_KASSA) |  | ЮKassa |
| public | [PAYMENT_NETWORK](YooKassa-Model-Payout-PayoutCancellationDetailsPartyCode.md#constant_PAYMENT_NETWORK) |  | «Внешние» участники процесса выплаты (например, эмитент, сторонний платежный сервис) |

---
### Properties
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| protected | [$validValues](YooKassa-Model-Payout-PayoutCancellationDetailsPartyCode.md#property_validValues) |  |  |
