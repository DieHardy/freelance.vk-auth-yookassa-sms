...
| ----------:| ---- | ---- | ------- |
| public | [$applied](YooKassa-Model-ThreeDSecure.md#property_applied) |  | Отображение пользователю формы для прохождения аутентификации по 3‑D Secure. |
...
| public | [getApplied()](YooKassa-Model-ThreeDSecure.md#method_getApplied) |  | Возвращает признак отображения пользователю формы для прохождения аутентификации по 3‑D Secure |
...
| public | [setApplied()](YooKassa-Model-ThreeDSecure.md#method_setApplied) |  | Устанавливает признак отображения пользователю формы для прохождения аутентификации по 3‑D Secure |
...
**Details:**
* Inherited From: [\YooKassa\Model\ThreeDSecure](YooKassa-Model-ThreeDSecure.md)
