...
| public | [$object](YooKassa-Model-Notification-NotificationPayoutCanceled.md#property_object) |  | Объект с информацией о выплате |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-Notification-NotificationPayoutCanceled.md#method___construct) |  | Конструктор объекта нотификации |
...
| public | [getObject()](YooKassa-Model-Notification-NotificationPayoutCanceled.md#method_getObject) |  | Возвращает объект с информацией о выплате, уведомление о которой хранится в текущем объекте |
...
**Details:**
* Inherited From: [\YooKassa\Model\Notification\NotificationPayoutCanceled](YooKassa-Model-Notification-NotificationPayoutCanceled.md)
