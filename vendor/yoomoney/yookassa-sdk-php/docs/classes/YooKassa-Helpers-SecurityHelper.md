...
| ----------:| ---- | ---- | ------- |
| public | [isIPTrusted()](YooKassa-Helpers-SecurityHelper.md#method_isIPTrusted) |  | Проверяет формат IP адреса и вызывает соответствующие методы для проверки среди IPv4 и IPv6 адресов Юkassa |
...
**Details:**
* Inherited From: [\YooKassa\Helpers\SecurityHelper](YooKassa-Helpers-SecurityHelper.md)
