...
| ----------:| ---- | ---- | ------- |
| public | [$party](YooKassa-Model-Payout-PayoutCancellationDetails.md#property_party) |  | Инициатор отмены выплаты |
| public | [$reason](YooKassa-Model-Payout-PayoutCancellationDetails.md#property_reason) |  | Причина отмены выплаты |
...
| public | [getParty()](YooKassa-Model-Payout-PayoutCancellationDetails.md#method_getParty) |  | Возвращает участника процесса выплаты, который принял решение об отмене транзакции |
| public | [getReason()](YooKassa-Model-Payout-PayoutCancellationDetails.md#method_getReason) |  | Возвращает причину отмены выплаты |
...
| public | [setParty()](YooKassa-Model-Payout-PayoutCancellationDetails.md#method_setParty) |  | Устанавливает участника процесса выплаты, который принял решение об отмене транзакции |
| public | [setReason()](YooKassa-Model-Payout-PayoutCancellationDetails.md#method_setReason) |  | Устанавливает причину отмены выплаты |
...
**Details:**
* Inherited From: [\YooKassa\Model\Payout\PayoutCancellationDetails](YooKassa-Model-Payout-PayoutCancellationDetails.md)
