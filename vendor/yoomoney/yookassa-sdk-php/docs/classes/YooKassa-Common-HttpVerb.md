...
| ----------:| ---- | ---- | ------- |
| public | [GET](YooKassa-Common-HttpVerb.md#constant_GET) |  | Http метод GET |
| public | [POST](YooKassa-Common-HttpVerb.md#constant_POST) |  | Http метод POST |
| public | [PATCH](YooKassa-Common-HttpVerb.md#constant_PATCH) |  | Http метод PATCH |
| public | [HEAD](YooKassa-Common-HttpVerb.md#constant_HEAD) |  | Http метод HEAD |
| public | [OPTIONS](YooKassa-Common-HttpVerb.md#constant_OPTIONS) |  | Http метод OPTIONS |
| public | [PUT](YooKassa-Common-HttpVerb.md#constant_PUT) |  | Http метод PUT |
| public | [DELETE](YooKassa-Common-HttpVerb.md#constant_DELETE) |  | Http метод DELETE |

---
### Properties
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| protected | [$validValues](YooKassa-Common-HttpVerb.md#property_validValues) |  |  |
