...
| ----------:| ---- | ---- | ------- |
| public | [factory()](YooKassa-Model-PaymentData-PaymentDataFactory.md#method_factory) |  | Фабричный метод создания объекта платежных данных по типу |
| public | [factoryFromArray()](YooKassa-Model-PaymentData-PaymentDataFactory.md#method_factoryFromArray) |  | Фабричный метод создания объекта платежных данных из массива |
...
**Details:**
* Inherited From: [\YooKassa\Model\PaymentData\PaymentDataFactory](YooKassa-Model-PaymentData-PaymentDataFactory.md)
