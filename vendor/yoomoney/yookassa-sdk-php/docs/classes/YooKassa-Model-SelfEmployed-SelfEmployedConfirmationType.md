...
| ----------:| ---- | ---- | ------- |
| public | [REDIRECT](YooKassa-Model-SelfEmployed-SelfEmployedConfirmationType.md#constant_REDIRECT) |  | Необходимо направить плательщика на страницу партнера |

---
### Properties
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| protected | [$validValues](YooKassa-Model-SelfEmployed-SelfEmployedConfirmationType.md#property_validValues) |  |  |
