...
| public | [$phone](YooKassa-Model-PaymentMethod-PaymentMethodMobileBalance.md#property_phone) |  | Номер телефона в формате ITU-T E.164 с которого плательщик собирается произвести оплату |
...
| public | [$type](YooKassa-Model-PaymentMethod-PaymentMethodMobileBalance.md#property_type) |  | Тип объекта |

---
### Methods
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-PaymentMethod-PaymentMethodMobileBalance.md#method___construct) |  |  |
...
| public | [getPhone()](YooKassa-Model-PaymentMethod-PaymentMethodMobileBalance.md#method_getPhone) |  | Возвращает номер телефона в формате ITU-T E.164 |
...
| public | [setPhone()](YooKassa-Model-PaymentMethod-PaymentMethodMobileBalance.md#method_setPhone) |  | Устанавливает номер телефона в формате ITU-T E.164 |
...
**Details:**
* Inherited From: [\YooKassa\Model\PaymentMethod\PaymentMethodMobileBalance](YooKassa-Model-PaymentMethod-PaymentMethodMobileBalance.md)
