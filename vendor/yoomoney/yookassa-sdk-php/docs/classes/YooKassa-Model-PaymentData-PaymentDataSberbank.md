...
| ----------:| ---- | ---- | ------- |
| public | [$phone](YooKassa-Model-PaymentData-PaymentDataSberbank.md#property_phone) |  |  |
...
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-PaymentData-PaymentDataSberbank.md#method___construct) |  |  |
...
| public | [getPhone()](YooKassa-Model-PaymentData-PaymentDataSberbank.md#method_getPhone) |  | Возвращает номер телефона в формате ITU-T E.164 |
...
| public | [setPhone()](YooKassa-Model-PaymentData-PaymentDataSberbank.md#method_setPhone) |  | Устанавливает номер телефона в формате ITU-T E.164 |
...
**Details:**
* Inherited From: [\YooKassa\Model\PaymentData\PaymentDataSberbank](YooKassa-Model-PaymentData-PaymentDataSberbank.md)
