...
| ----------:| ---- | ---- | ------- |
| public | [$party](YooKassa-Model-CancellationDetails.md#property_party) |  | Инициатор отмены платежа |
| public | [$reason](YooKassa-Model-CancellationDetails.md#property_reason) |  | Причина отмены платежа |

---
### Methods
| Visibility | Name | Flag | Summary |
| ----------:| ---- | ---- | ------- |
| public | [__construct()](YooKassa-Model-CancellationDetails.md#method___construct) |  | CancellationDetails constructor. |
...
| public | [getParty()](YooKassa-Model-CancellationDetails.md#method_getParty) |  | Возвращает участника процесса платежа, который принял решение об отмене транзакции |
| public | [getReason()](YooKassa-Model-CancellationDetails.md#method_getReason) |  | Возвращает причину отмены платежа |
...
| public | [setParty()](YooKassa-Model-CancellationDetails.md#method_setParty) |  | Устанавливает участника процесса платежа, который принял решение об отмене транзакции |
| public | [setReason()](YooKassa-Model-CancellationDetails.md#method_setReason) |  | Устанавливает причину отмены платежа |
...
* Implements:
  * [\YooKassa\Model\CancellationDetailsInterface](YooKassa-Model-CancellationDetailsInterface.md)
...
**Details:**
* Inherited From: [\YooKassa\Model\CancellationDetails](YooKassa-Model-CancellationDetails.md)
