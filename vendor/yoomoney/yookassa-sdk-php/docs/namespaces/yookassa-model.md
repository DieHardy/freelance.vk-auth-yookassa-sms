...
* [\YooKassa\Model\Confirmation](yookassa-model-confirmation.md)
* [\YooKassa\Model\ConfirmationAttributes](yookassa-model-confirmationattributes.md)
* [\YooKassa\Model\Deal](yookassa-model-deal.md)
* [\YooKassa\Model\Notification](yookassa-model-notification.md)
* [\YooKassa\Model\PaymentData](yookassa-model-paymentdata.md)
* [\YooKassa\Model\PaymentMethod](yookassa-model-paymentmethod.md)
* [\YooKassa\Model\Payout](yookassa-model-payout.md)
* [\YooKassa\Model\PersonalData](yookassa-model-personaldata.md)
* [\YooKassa\Model\Receipt](yookassa-model-receipt.md)
* [\YooKassa\Model\SelfEmployed](yookassa-model-selfemployed.md)
* [\YooKassa\Model\Webhook](yookassa-model-webhook.md)
